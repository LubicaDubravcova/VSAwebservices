...
public class NewJerseyClient {
    ...
    private static final String BASE_URI = "http://localhost:8080/Cviko10Uloha1/webresources";
    ...
    public void deletePolozka(String index) throws ClientErrorException {
        webTarget.path(java.text.MessageFormat.format("{0}", new Object[]{index})).request().delete();
    }

    public String getPonuka() throws ClientErrorException {
        WebTarget resource = webTarget;
        return resource.request(javax.ws.rs.core.MediaType.TEXT_PLAIN).get(String.class);
    }

    public <T> T postJedlo(Object requestEntity, Class<T> responseType) throws ClientErrorException {
    ...
    public void putPolozka(Object requestEntity, String index) throws ClientErrorException {
    ...
    public <T> T getPolozka(Class<T> responseType, String index) throws ClientErrorException {
        WebTarget resource = webTarget;
